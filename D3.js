const starWarsCharacters = [
  ...
  },
  {
    ...
    height: 183,
    mass: 184 /* cambuato la massa qui */,
    hair_color: "black",
    skin_color: "light",
    eye_color: "brown",
    birth_year: "24BBY",
...
console.log("numero elementi starWarsCharacters:", starWarsCharacters.length);
...
console.log(
  " Nomi personaggi. Aggiunti al nuovo array? Prova:" + charactersNames
);
...
for (let i = 0; i < starWarsCharacters.length; i++)
  switch (starWarsCharacters[i].eye_color) {
    ...
    case "blue-gray":
      ...
      break;
    default:
      console.log("prova prova", starWarsCharacters[i].eye_color);
  }
console.log(
  "Personaggi in base al colore degli occhi:" + eyeColor
); /* non ho capito perche non funziona. sono stupido? */
...
for (let i = 0; i < starWarsCharacters.length; i++)
  if (starWarsCharacters[i].gender === "n/a") {
    starWarsCharacters[i].gender = "rebot";
  }
